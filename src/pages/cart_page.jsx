                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="search">
                                ...
                                <input type="text" class="form-control" placeholder="Tìm sản phẩm, thương hiệu, và tên shop" />
                        ...
                        shops.map((shop) => (
                            <div className="item_in_cart  py-3 px-4 rounded shadow-sm">
                                <ul class="row list-unstyled align-items-center pt-4 pb-4">
                                    <li class="col">
                                        <div class="z_checkbox  px-3">
                                            <input class="check-input" type="checkbox" id="buy_all_in_shop" name="check_buy_all" value="buy_all" />
                                                    ...
                                                    <ul class="item_in_shop row list-unstyled align-items-center pt-3">
                                                        <li class="col">
                                                            <div class="z_checkbox px-3">
                                                                <input
                                                                    ...
                                                                    name="check_buy_all"
                                                                    value="buy_all"
                                                                    checked={localStorage.getItem(`${item.product_id}`) === "true"}
                                                                    onChange={(e) => {
                                                                        handleCheckboxChange(item.product_id);
                                                                        if(e.target.checked){
                                                                            localStorage.setItem(`shopName_${item.product_id}`, shop.shop_name)
                                                                            localStorage.setItem(`productName_${item.product_id}`, item.name)
                                                                            localStorage.setItem(`productImage_${item.product_id}`, item.product_image)
                                                                            localStorage.setItem(`classification_${item.product_id}`, item.classification_name.join(", "))
                                                                        }
                                                                    }}
                                                                />
                                                        ...
                                                        <div class="col">
                                                            <ul class="row list-unstyled">
                                                                <li class="col text-center price">{item.sale_price.toLocaleString('vi-VN')}</li>
                                                                <CartState id={item.product_id} o_price={item.sale_price} stock={item.stock} />
                                                                <li class="col text-center action d-flex flex-column">
                                                                    <button className="remove_btn mb-2" onClick={() => deleteProduct(shop.shop_id, item.product_id)}>
                                                                        Xóa
                                                                    </button>
                    ...
                    <div class="bg-white py-3 px-4 rounded shadow-sm">
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 text-end fs-5">
                                Tổng đơn hàng: <span class="total_price fw-bold">₫{totalPrice.toLocaleString('vi-VN')}</span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 d-flex align-items-center">
                                <div class="z_checkbox px-3">
                                                                        <input class="check-input" type="checkbox" id="buy_all" name="check_buy_all" value="buy_all"
                                                                    onChange={() => {
                                                                        handleCheckboxChange(1, true);
                                                                        
                                                                    }}/>
                                    <label class="form-check-label" for="check_buy_all">Chọn tất cả</label>
                                </div>
                                <button className="remove_btn remove_all_btn px-5" onClick={() => deleteAllProduct()}>Xóa tất cả sản phẩm</button>
                            </div>
                            <div class="col-md-6 text-end mt-3 mb-3">
                                <Link class="purchase_btn reset_a" to="/PlaceOrderPage">Tiến hành thanh toán</Link>
                            </div>
                        </div>
                    </div>
                </section>
